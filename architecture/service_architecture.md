...
graph TD
    ...
    subgraph "AI Provider Integration"
        ANTHROPIC_CLIENT[Anthropic Client - Analysis + OCR]
        OPENAI_CLIENT[OpenAI Client - Embeddings Only]
    end
    ...
    UNIFIED --> ANTHROPIC_CLIENT
    MODULAR --> ANTHROPIC_CLIENT
    SPECIFIC --> ANTHROPIC_CLIENT
    ...
    ANALYZE_CHUNK --> ANTHROPIC_CLIENT
    GENERATE_EMBEDDINGS --> OPENAI_CLIENT
```
